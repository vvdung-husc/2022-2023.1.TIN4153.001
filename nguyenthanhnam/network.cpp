...
int main(int argc, char const *argv[])
{
  ...
  std::string url = "http://www.cs.sjsu.edu/~pearce/modules/lectures/web/html/HTTP_files/image001.jpg";
  // std::string url="http://tuyensinh.husc.edu.vn/category/quyche/";
  Uri u = Uri::Parse(url);
  //saveHost2Html(u.Host.c_str(),u.getPort(),"/","test.html");
  saveHost2Html(u.Host.c_str(),u.getPort(),u.getPath(),"quyche1.html");
